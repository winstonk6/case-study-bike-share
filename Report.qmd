...
casual_dest |> 
  ...
  mapshot2(file = "map_destination_casual.png")
```

![Map of 20 most frequent destinations for casual riders](map_destination_casual.png)
...
member_dest |> 
  ...
  mapshot2(file = "map_destination_member.png")
```

![Map of 20 most frequent destinations for members](map_destination_member.png)
